    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('customers.createcustomer') }}" class="btn btn-added"><img
                            src="{{ asset('assets/img/icons/plus.svg') }}" alt="img">Add Customer</a>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($customers as $customer)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="me-3" href="{{ route('customers.editcustomer', $customer->id) }}">

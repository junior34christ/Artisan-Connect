    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('suppliers.createsupplier') }}" class="btn btn-added"><img
                            src="{{ asset('assets/img/icons/plus.svg') }}" alt="img">Add Supplier</a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="javascript:void(0);" class="product-img">
                                                <img src="{{ Storage::url($supplier->image) }}" alt="img">
                                            </a>
                                        ...
                                        <td>
                                            <a class="me-3" href="{{ route('suppliers.editsupplier', $supplier->id) }}">

...
<!-- Mirrored from demo.foxthemes.net/socialite-v3.0/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Apr 2024 02:19:01 GMT -->
...
<head>
    ...
    <title>Retrouver des artisans de tout métier</title>
    <meta name="description" content="Socialite - Social sharing network HTML Template">

    <!-- css files -->
    <link rel="stylesheet" href="{{ URL::to('assets2/css/tailwind.css') }}">
...
<body>
                    ...
                    <div class="flex items-center gap-1"> 
                        ...
                        <div id="logo">
                            <a href="{{ route('Acceuil')}}"> 
                                <img src="{{ asset('assets/img/photo.png') }}" alt="" class="w-28 md:block hidden dark:!hidden">
                                {{-- <img src="{{ asset('assets2/images/logo-light.png') }}" alt="" class="dark:md:block hidden"> --}}
                                <img src="{{ asset('assets/img/photo.png') }}" class="hidden max-md:block w-20 dark:!hidden" alt="">
                                {{-- <img src="{{ asset('assets2/images/logo-mobile-light.png') }}" class="hidden dark:max-md:block w-20" alt=""> --}}
                            </a>
                        </div>
                        ...
                        <div class="hidden uk- open z-10"
                                ...
                                <div class="xl:w-[694px] sm:w-96 bg-white dark:bg-dark3 w-screen p-2 rounded-lg shadow-lg -mt-14 pt-14">
                                    ...
                                    <nav class="text-sm font-medium text-black dark:text-white">
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="{{ asset('assets2/images/avatars/avatar-2.jpg') }}" class="w-9 h-9 rounded-full"> <div>   <div> Jesse Steeve </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Artisan </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        {{-- <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="{{ asset('assets2/images/avatars/avatar-2.jpg') }}" class="w-9 h-9 rounded-full"> <div>   <div>  Martin Gray </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Artisan </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="{{ asset('assets2/images/group/group-2.jpg') }}" class="w-9 h-9 rounded-full"> <div>   <div>  Delicious Foods  </div>  <div class="text-xs text-rose-500 font-medium mt-0.5">  Group </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="{{ asset('assets2/images/group/group-1.jpg') }}" class="w-9 h-9 rounded-full"> <div>   <div> Delicious Foods  </div>  <div class="text-xs text-yellow-500 font-medium mt-0.5">  Page </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a> --}}
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="{{ asset('assets2/images/avatars/avatar-6.jpg') }}" class="w-9 h-9 rounded-full"> <div>   <div>  John Welim </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Artisan </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>   
        ...
        <main id="site__main"
            ...
            <div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
                ...
                <div class="page-heading">
                    ...
                    <h1 class="page-title"> Avez-vous bésoin d'un service ?? <br> Retrouver les meilleurs Artisan ici !
                    </h1>
                        ...
                        <ul class="uk-slider-items grid-small">
                                ...
                                <div class="card">
                                    <a href="#">
                                        <div class="card-media h-32">
                                            <img src="{{ asset('assets/img/artisan/34365680-46b2-42a6-8b03-ae52308fd38a.jpg') }}"
                                                alt="">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="#">
                                            <p class="card-text text-black mt-2"> Côte D'ivoire </p>
                                        </a>
                                        <div class="card-list-info text-xs mt-1">
                                            <div> 26 Intéressé</div>
                                            <div class="md:block hidden">·</div>
                                        </div>
                                        <div class="flex gap-2">
                                            <button type="button"
                                                class="button bg-primary text-white flex-1">Intéressé</button>
                                            <button type="button" class="button bg-secondery !w-auto"> <ion-icon
                                                    name="arrow-redo" class="text-lg"></ion-icon> </button>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="#">
                                        <div class="card-media h-32">
                                            <img src="{{ asset('assets/img/artisan/OIP.jpg') }}" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                            ...
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="#">
                                        <div class="card-media h-32">
                                            <img src="{{ asset('assets/img/artisan/R.jpg') }}" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                            ...
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="#">
                                        <div class="card-media h-32">
                                            <img src="{{ asset('assets/img/artisan/OIP1.jpg') }}" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                            ...
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="#">
                                        <div class="card-media h-32">
                                            <img src="{{ asset('assets/img/artisan/télécharger.jpg') }}"
                                                alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                ...
                <div class="sm:my-6 my-3 flex items-center justify-between md:mt-10">
                    <div>
                        <h2 class="text-xl font-semibold"> Métiers qui pourraient vous intéresser</h2>
                        <p class="font-normal text-sm text-gray-500 leading-6"> Trouvez un groupe en parcourant les
                    ...
                    <div class="uk-slider-container pb-1">
                        ...
                        <ul class="uk-slider-items grid-small">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/OIP.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                                                <div class="text-sm font-light"> Côte D'ivoire </div>
                                                <div class="text-lg leading-3 mt-1.5"> Restaurant </div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/OIP1.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/R.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                                                <div class="text-sm font-light"> Côte D'ivoire </div>
                                                <div class="text-lg leading-3 mt-1.5"> Mécanique </div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/OIP2.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/OIP3.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                                                <div class="text-sm font-light"> Côte D'ivoire </div>
                                                <div class="text-lg leading-3 mt-1.5"> Coiffure </div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/OIP4.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/R1.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/IMG-20240718-WA0026.png') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                                                <div class="text-sm font-light"> Côte D'ivoire </div>
                                                <div class="text-lg leading-3 mt-1.5"> Menuiserie </div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="{{ asset('assets/img/télécharger.jpg') }}" alt=""
                                            class="h-36 w-full object-cover">
                                        <div
                                            class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                ...
                <div class="flex items-center justify-between text-black dark:text-white py-3 mt-6">
                    <h3 class="text-xl font-semibold"> Autre artisan </h3>
                    <a href="#" class="text-sm text-blue-500">Voir tout</a>
                </div>
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-2.5 mt-4">
                    ...
                    <div class="card">
                        <a href="#">
                            <div class="card-media h-32">
                                <img src="{{ asset('assets/img/artisan/télécharger.jpg') }}" alt="">
                                <div class="card-overly"></div>
                            </div>
                        </a>
                        <div class="card-body">
    ...
    <div>
        <button type="button"
            ...
            <div class="text-base font-semibold max-sm:hidden"> Barvarder </div>
...
<!-- Mirrored from demo.foxthemes.net/socialite-v3.0/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Apr 2024 02:19:06 GMT -->

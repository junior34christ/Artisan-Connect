                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-sm-2 col-2 ps-0">
                                        <div class="add-icon">
                                            <a href="javascript:void(0);"><img src="assets/img/icons/plus1.svg"
                                                    alt="img"></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="delete-set" href="{{ route('products.destroy', $product->id) }}"
                    ...
                    .then(data => {
                        ...
                        if (data.length > 0) {
                            data.forEach(product => {
                                results.innerHTML += `<div>${product.name}</div>`;
                            });
                        } else {
                            results.innerHTML = '<div>Ce article n\'existe pas</div>';
                        }
                    });
            }
        }
